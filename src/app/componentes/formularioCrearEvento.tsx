...
import { EsquemaCrearEvento } from "../actions/validacionCrearEvento";
import { Inter } from "next/font/google";
import { crearEvento } from "../api/crearEvento";
...
export default function FormularioCrearEvento() {
  ...
  const { register, handleSubmit, reset, formState:{errors} } = useForm({
    resolver: zodResolver(EsquemaCrearEvento)
  });
  ...
  const onSubmit = async(data: {
    ...
    try {
      await crearEvento(data, archivo);
